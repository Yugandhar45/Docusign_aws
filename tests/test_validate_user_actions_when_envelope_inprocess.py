...
class Test_Validate_EnvelopeRouting:
    ...
    def test_validate_user_action(self, request):
        ...
        utils.execute_script_with_banner("Adding Signature Tag and comment tag as a sender for Recipient-1")
        sign.addSignatureTag(350)
        ...
        utils.execute_script_with_banner("Delete the existing recipient and adding the new recipient")
        ...
        utils.execute_script_with_banner("Replacing the document")
