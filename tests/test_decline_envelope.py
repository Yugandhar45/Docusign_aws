...
class Test_DeclineEnvelope:
    def test_declineEnvelope(self, request):
        ...
        Util_Test.getscreenshot('/1.signature_tag1.png')
        ...
        Util_Test.getscreenshot('/2.signature_tag2.png')
        sign.click_send_btn()
        ...
        Util_Test.getscreenshot('/3.Decline_Envelope.png')
    ...
    def test_verify_decline_notification(self, request):
        ...
        Util_Test.getscreenshot('/4.Envelope_declined_notification_to_sender.png')
