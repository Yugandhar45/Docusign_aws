...
class Test_NoDel_SignedDoc:
    def test_NoDel_SignedDoc(self, request):
        ...
        utils.execute_script_with_banner("Home page is launched")
        ...
        Util_Test.getscreenshot('/1.Assigned_recipients.png')
        ...
        Util_Test.getscreenshot('/2.signature_tag1.png')
        ...
        Util_Test.getscreenshot('/3.signature_tag2.png')
        ...
        Util_Test.getscreenshot("/4.Delete_and_Replace_button_disabled.png")
